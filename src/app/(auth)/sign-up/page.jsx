...
export default async function Home() {
  ...
  return (
    <section className="w-full h-full min-h-screen text-black">
      <div className="flex mx-auto justify-center items-center min-h-screen w-full p-4 backdrop:fill-transparent backdrop-filter blueGreen opacity-90 transition-all hover:from-black hover:to-slate-500 hover:animate-pulse-plus"
      >
