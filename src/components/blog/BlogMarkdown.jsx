			...
			components={{
				...
				h2: ({ node, ...props }) => {
					return (
						<h2
							{...props}
							className="text-[21px] font-semibold py-1.5 transition-all"
						/>
					);
				},
				h3: ({ node, ...props }) => {
					return (
						<h3
							{...props}
							className="text-[18px] py-1.5 transition-all"
						/>
					);
				},
				ul: ({ node, ...props }) => {
					return (
						<ul
							{...props}
							className="text-[17px] py-1.5 px-2 list-disc transition-all no-underline"
						/>
					);
				},
				ol: ({ node, ...props }) => {
					return (
						<ol
							{...props}
							className="text-[17px] py-1.5 px-2 list-decimal transition-all"
						/>
					);
				},
				li: ({ node, ...props }) => {
					return (
						<li
							{...props}
							className="text-[16px] py-1.5 transition-all"
						/>
					);
				},
				a: ({ node, ...props }) => {
